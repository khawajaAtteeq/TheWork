...
{
    /// <summary>
    /// class “NLogger”, which will responsible for all types
    ///  of errors and info logging, to same Helper folder.
    ///  Here NLogger class implements ITraceWriter interface,
    ...
    public sealed class NLogger:ITraceWriter
    {
        ...
        private static readonly Lazy<Dictionary<TraceLevel, 
            Action<string>>> LoggingMap = new Lazy<Dictionary<TraceLevel, 
                Action<string>>>(() => new Dictionary<TraceLevel, 
                Action<string>> { { TraceLevel.Info, ClassLogger.Info },
